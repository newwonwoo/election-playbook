...
function HomeScreen({ onStart, onChapterSelect, onHandout }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position:"relative", maxWidth:"560px", width:"100%", textAlign:"center",
        opacity: phase ? 1 : 0, transition:"opacity 0.8s"
      }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth:"600px", margin:"0 auto" }}>
        ...
        <div style={{ fontSize:"11px", fontWeight:"800", color:"#e6c619", letterSpacing:"4px", marginBottom:"8px" }}>챕터 선택</div>
        <div style={{ fontSize:"22px", fontWeight:"900", color:"#f5f2ea", fontFamily:"Georgia,serif", marginBottom:"32px" }}>어디서부터 시작할까?</div>
        <div style={{ display:"flex", flexDirection:"column", gap:"10px" }}>
          {allEps.map((ep, i) => {
            const isFinal = ep.id === 8;
            return (
              <button key={ep.id} onClick={() => onSelect(i, isFinal)} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor=isFinal?"rgba(220,80,80,0.6)":"rgba(230,198,25,0.4)"; e.currentTarget.style.background="rgba(255,255,255,0.03)"; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor="rgba(255,255,255,0.08)"; e.currentTarget.style.background="#0f0f1a"; }}>
                <div>
                  ...
                  <div style={{ fontSize:"15px", fontWeight:"800", color:"#f5f2ea" }}>{ep.title}</div>
                </div>
